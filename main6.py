...
to answer question using only the content of the document.
"""
...
#1. load the documment
with open("notes.txt", "r", encoding="utf-8") as f:
	text = f.read()

#2. split it into small chunks (s0 retrieval is more precise)
...
while True:
	...
	# Retrieve the most relevent chunks for this question
	...
	"If the ansqer isn't in the context, say you don't know. \n\n"
	f"Context:\n{context}"
	))
